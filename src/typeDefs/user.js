...
extend type Mutation{
    signUp(email: String!, username: String!, name: String!, password: String! ): User #User object might or might not be returned if the user has already been registered 
}
